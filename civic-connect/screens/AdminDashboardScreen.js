...
//   }, [complaints, searchQuery, statusFilter, issueTypeFilter, wardFilter, page, perPage]);
...
//               <Picker.Item label="All Issue Types" value="All" />
//               {[...new Set(complaints.map((c) => c.issueType))].map((type) => (
...
//     marginBottom: 10,
//   },
//   wardInsightsButton: { backgroundColor: "#007bff", padding: 10, borderRadius: 8, flex: 1, marginRight: 5 },
//   analyticsButton: { backgroundColor: "#10b981", padding: 10, borderRadius: 8, flex: 1, marginLeft: 5 },
//   buttonText: { color: "white", fontWeight: "bold", textAlign: "center" },

//   refreshContainer: { alignItems: "center", marginBottom: 10 },
//   refreshButton: { backgroundColor: "#d1d5db", padding: 12, borderRadius: 8, width: "70%" },
