...
//   // Fetch default location data when screen loads
//   useEffect(() => {
...
//   heading: { fontSize: 22, fontWeight: "bold", marginBottom: 8, textAlign: "center" },
...
//   noDataText: { textAlign: "center", color: "gray", marginTop: 20, fontSize: 16 },
// });
...
export default function AdminWardInsightsScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* 👇 NEW BUTTON to go to full chart screen */}
      <TouchableOpacity
